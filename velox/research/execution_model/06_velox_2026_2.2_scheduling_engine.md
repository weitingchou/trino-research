...
- [6. Key Design Insights](#6-key-design-insights)
  - [Insight 1: The Executor is a Thin, External Abstraction](#insight-1-the-executor-is-a-thin-external-abstraction)
  - [Insight 2: CPU Fairness is Achieved Through Cooperative Time-Slicing at Two Levels](#insight-2-cpu-fairness-is-achieved-through-cooperative-time-slicing-at-two-levels)
  - [Insight 3: The Task Mutex is the Central Serialization Point for All Scheduling Decisions](#insight-3-the-task-mutex-is-the-central-serialization-point-for-all-scheduling-decisions)
  - [Insight 4: Blocking is Handled via folly Futures with Inline Re-enqueue](#insight-4-blocking-is-handled-via-folly-futures-with-inline-re-enqueue)
  - [Insight 5: Atomic Fast-Path Checks Minimize Lock Contention in the Hot Loop](#insight-5-atomic-fast-path-checks-minimize-lock-contention-in-the-hot-loop)
  - [Insight 6: Grouped Execution Provides Split-Group-Level Concurrency Control](#insight-6-grouped-execution-provides-split-group-level-concurrency-control)
  - [Insight 7: The Suspend Mechanism Enables Memory Arbitration Without Losing Stack Context](#insight-7-the-suspend-mechanism-enables-memory-arbitration-without-losing-stack-context)
  - [Insight 8: Dynamic Scan Scaling Adapts Thread Usage to Memory Pressure](#insight-8-dynamic-scan-scaling-adapts-thread-usage-to-memory-pressure)
