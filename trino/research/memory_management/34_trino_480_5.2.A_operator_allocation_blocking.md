...
- [3. Execution & Call Flow](#3-execution-call-flow)
  - [3.1 The Decorator Stack: Operator to SimpleLocalMemoryContext](#31-the-decorator-stack-operator-to-simplelocalmemorycontext)
  - [3.2 Complete Execution Path: `setBytes()` Success (Pool Has Memory)](#32-complete-execution-path-setbytes-success-pool-has-memory)
  - [3.3 Complete Execution Path: `setBytes()` When Pool Is Exhausted (Blocking)](#33-complete-execution-path-setbytes-when-pool-is-exhausted-blocking)
  - [3.4 `updateMemoryFuture()` -- The Lock-Free Cross-Thread Bridge](#34-updatememoryfuture-the-lock-free-cross-thread-bridge)
  - [3.5 Complete Execution Path: `setBytes()` When Per-Query Limit Exceeded (Exception)](#35-complete-execution-path-setbytes-when-per-query-limit-exceeded-exception)
  - [3.6 Driver Integration: From Blocked Future to Yield](#36-driver-integration-from-blocked-future-to-yield)
  - [3.7 `MemoryPool.free()` -- Unblocking the Chain](#37-memorypoolfree-unblocking-the-chain)
  - [3.8 `trySetBytes()` Path -- Non-Blocking Probe](#38-trysetbytes-path-non-blocking-probe)
  - [3.9 HashBuilderOperator.finishInput() -- The Yield-Before-Build Pattern](#39-hashbuilderoperatorfinishinput-the-yield-before-build-pattern)
- [4. Concurrency & State Management](#4-concurrency-state-management)
  - [Threading Model](#threading-model)
  - [Synchronization Hierarchy (Lock Acquisition Order)](#synchronization-hierarchy-lock-acquisition-order)
  - [State Machine: Operator Memory Lifecycle](#state-machine-operator-memory-lifecycle)
  - [The `AtomicReference<SettableFuture<Void>>` Cross-Thread Protocol](#the-atomicreferencesettablefuturevoid-cross-thread-protocol)
- [5. Memory & Resource Profile](#5-memory-resource-profile)
  - [Allocation Patterns by Operator](#allocation-patterns-by-operator)
  - [Future Types in the System](#future-types-in-the-system)
  - [Memory Overhead of the Tracking Infrastructure](#memory-overhead-of-the-tracking-infrastructure)
  - [`CoarseGrainLocalMemoryContext` Reduction Factor](#coarsegrainlocalmemorycontext-reduction-factor)
- [6. Key Design Insights](#6-key-design-insights)
- [7. Porting Considerations (Java -> Target Architecture)](#7-porting-considerations-java-target-architecture)
  - [Key Translation Challenges](#key-translation-challenges)
  - [Recommended Rust Abstractions](#recommended-rust-abstractions)
  - [Critical Porting Decision: Lock Cascade vs. Single Lock](#critical-porting-decision-lock-cascade-vs-single-lock)
