...
- [2. Structural Architecture](#2-structural-architecture)
  - [SyntheticAddress (row addressing)](#syntheticaddress-row-addressing)
  - [PagesIndex (row accumulator)](#pagesindex-row-accumulator)
  - [DefaultPagesHash (general hash table)](#defaultpageshash-general-hash-table)
  - [BigintPagesHash (optimized single-bigint hash table)](#bigintpageshash-optimized-single-bigint-hash-table)
  - [PositionLinks (collision chains)](#positionlinks-collision-chains)
