...
- [2. Structural Architecture](#2-structural-architecture)
  - [Block Type Hierarchy (sealed)](#block-type-hierarchy-sealed)
  - [Fixed-Width ValueBlock Layout (LongArrayBlock, IntArrayBlock, ByteArrayBlock, ShortArrayBlock, Fixed12Block, Int128ArrayBlock)](#fixed-width-valueblock-layout-longarrayblock-intarrayblock-bytearrayblock-shortarrayblock-fixed12block-int128arrayblock)
  - [Variable-Width ValueBlock Layout (VariableWidthBlock)](#variable-width-valueblock-layout-variablewidthblock)
  - [DictionaryBlock Layout](#dictionaryblock-layout)
  - [RunLengthEncodedBlock Layout](#runlengthencodedblock-layout)
  - [Size Semantics (Three Distinct Metrics)](#size-semantics-three-distinct-metrics)
  - [Class Diagram](#class-diagram)
- [3. Execution and Call Flow](#3-execution-and-call-flow)
  - [Sequence Diagram: Page Processing Pipeline](#sequence-diagram-page-processing-pipeline)
...
- [5. Memory and Resource Profile](#5-memory-and-resource-profile)
  - [Page Memory Anatomy](#page-memory-anatomy)
  - [Fixed-Width Block Memory](#fixed-width-block-memory)
  - [Variable-Width Block Memory](#variable-width-block-memory)
  - [DictionaryBlock Memory Amplification](#dictionaryblock-memory-amplification)
  - [Page.compact() Strategy](#pagecompact-strategy)
  - [BlockBuilder Growth Strategy](#blockbuilder-growth-strategy)
  - [Memory Context Integration](#memory-context-integration)
- [6. Key Design Insights](#6-key-design-insights)
  - [Insight 1: The arrayOffset Pattern Enables Universal Zero-Copy Slicing](#insight-1-the-arrayoffset-pattern-enables-universal-zero-copy-slicing)
  - [Insight 2: Block.getPositions() Defaults to DictionaryBlock Wrapping](#insight-2-blockgetpositions-defaults-to-dictionaryblock-wrapping)
  - [Insight 3: DictionaryBlock.createInternal() Automatically Unwraps Nested Dictionaries](#insight-3-dictionaryblockcreateinternal-automatically-unwraps-nested-dictionaries)
  - [Insight 4: DictionaryAwarePageProjection Caches Dictionary Results Across Batches](#insight-4-dictionaryawarepageprojection-caches-dictionary-results-across-batches)
  - [Insight 5: BlockBuilder.appendBlockRange() Is the Universal Copy Dispatch](#insight-5-blockbuilderappendblockrange-is-the-universal-copy-dispatch)
  - [Insight 6: Sealed Block Hierarchy Enables Exhaustive Pattern Matching](#insight-6-sealed-block-hierarchy-enables-exhaustive-pattern-matching)
  - [Insight 7: getSizeInBytes() vs getRetainedSizeInBytes() Drive Different Decisions](#insight-7-getsizeinbytes-vs-getretainedsizeinbytes-drive-different-decisions)
  - [Insight 8: SelectedPositions Is a Dual-Mode Position Representation](#insight-8-selectedpositions-is-a-dual-mode-position-representation)
  - [Insight 9: Page Column Selection Is Zero-Copy Reference Reshuffling](#insight-9-page-column-selection-is-zero-copy-reference-reshuffling)
  - [Insight 10: BlockBuilder.build() Can Return RLE for All-Null Columns](#insight-10-blockbuilderbuild-can-return-rle-for-all-null-columns)
  - [Insight 11: SourcePage.selectPositions() Enables Reader-Level Push-Down](#insight-11-sourcepageselectpositions-enables-reader-level-push-down)
  - [Insight 12: Page.compact() Handles Dictionary Blocks as a Group](#insight-12-pagecompact-handles-dictionary-blocks-as-a-group)
- [7. Porting Considerations (Java to Rust)](#7-porting-considerations-java-to-rust)
  - [Zero-Copy View Pattern](#zero-copy-view-pattern)
  - [Sealed Hierarchy to Enum](#sealed-hierarchy-to-enum)
  - [Null Representation](#null-representation)
  - [BlockBuilder to Vec-Based Builder](#blockbuilder-to-vec-based-builder)
  - [DictionaryId Can Use Atomic Counter](#dictionaryid-can-use-atomic-counter)
  - [Page Compaction](#page-compaction)
  - [SourcePage Lazy Loading](#sourcepage-lazy-loading)
