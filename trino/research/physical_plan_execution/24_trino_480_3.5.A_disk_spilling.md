...
- [3. Execution & Call Flow](#3-execution-call-flow)
  - [Sequence Diagram -- Full Spill Lifecycle (Hash Aggregation)](#sequence-diagram-full-spill-lifecycle-hash-aggregation)
  - [Sequence Diagram -- Hash Join Build-Side Spill](#sequence-diagram-hash-join-build-side-spill)
- [4. Concurrency & State Management](#4-concurrency-state-management)
- [5. Memory & Resource Profile](#5-memory-resource-profile)
- [6. Key Design Insights](#6-key-design-insights)
- [7. Porting Considerations (Java -> Target Architecture) *(Optional)*](#7-porting-considerations-java-target-architecture-optional)
