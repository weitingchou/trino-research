...
- [3. Execution & Call Flow](#3-execution-call-flow)
  - [3.1 The Private Constructor & Trust Boundary](#31-the-private-constructor-trust-boundary)
  - [3.2 Page Construction via PageBuilder](#32-page-construction-via-pagebuilder)
  - [3.3 `getColumns()` -- Zero-Copy Column Projection](#33-getcolumns-zero-copy-column-projection)
  - [3.4 `prependColumn()` -- Zero-Copy Column Prepend](#34-prependcolumn-zero-copy-column-prepend)
  - [3.5 `appendColumn()` -- Zero-Copy Column Append](#35-appendcolumn-zero-copy-column-append)
  - [3.6 `getRegion()` -- Zero-Copy Row Slicing](#36-getregion-zero-copy-row-slicing)
  - [3.7 `getPositions()` -- Zero-Copy Row Filtering](#37-getpositions-zero-copy-row-filtering)
  - [3.8 `copyPositions()` -- Deep-Copy Row Filtering](#38-copypositions-deep-copy-row-filtering)
  - [3.9 `compact()` -- In-Place Memory Reclamation](#39-compact-in-place-memory-reclamation)
  - [Complete Method Taxonomy](#complete-method-taxonomy)
- [4. Concurrency & State Management](#4-concurrency-state-management)
  - [Threading Model](#threading-model)
- [5. Memory & Resource Profile](#5-memory-resource-profile)
  - [Allocation Patterns](#allocation-patterns)
  - [Size Accounting: `sizeInBytes` vs `retainedSizeInBytes`](#size-accounting-sizeinbytes-vs-retainedsizeinbytes)
  - [Zero-Copy Implications for Memory Sharing](#zero-copy-implications-for-memory-sharing)
