...
- [2. Structural Architecture](#2-structural-architecture)
  - [2.1 Primary Source Files](#21-primary-source-files)
  - [2.2 Internal Metadata Fields (v2.3 -- Current)](#22-internal-metadata-fields-v23-current)
  - [2.3 Static VarHandle Fields (Typed Access Layer)](#23-static-varhandle-fields-typed-access-layer)
  - [2.4 Historical Metadata Fields (v0.45 -- Contrast)](#24-historical-metadata-fields-v045-contrast)
  - [2.5 Class Diagram](#25-class-diagram)
- [3. Execution & Call Flow](#3-execution-call-flow)
  - [3.1 Typed Read Path (VarHandle in v2.3)](#31-typed-read-path-varhandle-in-v23)
  - [3.2 Where `sun.misc.Unsafe` Is Actually Used in v2.3](#32-where-sunmiscunsafe-is-actually-used-in-v23)
  - [3.3 Sequence Diagram: Typed Access (v2.3 VarHandle Path)](#33-sequence-diagram-typed-access-v23-varhandle-path)
  - [3.4 Sequence Diagram: Bulk Typed Array Copy (Unsafe Path in v2.3)](#34-sequence-diagram-bulk-typed-array-copy-unsafe-path-in-v23)
  - [3.5 Sequence Diagram: Growth via `ensureSize`](#35-sequence-diagram-growth-via-ensuresize)
  - [3.6 Contrasting the Historical Unsafe-Only Path (v0.45)](#36-contrasting-the-historical-unsafe-only-path-v045)
- [4. Concurrency & State Management](#4-concurrency-state-management)
- [5. Memory & Resource Profile](#5-memory-resource-profile)
  - [5.1 Allocation Pattern](#51-allocation-pattern)
  - [5.2 Memory Tracking](#52-memory-tracking)
  - [5.3 Lifecycle](#53-lifecycle)
  - [5.4 Unsafe Memory Usage in SizeOf](#54-unsafe-memory-usage-in-sizeof)
- [6. Key Design Insights](#6-key-design-insights)
- [7. Porting Considerations (Java -> Rust)](#7-porting-considerations-java-rust)
  - [7.1 Translation Blockers](#71-translation-blockers)
  - [7.2 Recommended Abstractions](#72-recommended-abstractions)
  - [7.3 Architectural Recommendation](#73-architectural-recommendation)
