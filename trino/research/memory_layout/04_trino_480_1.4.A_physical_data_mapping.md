...
- [1. High-Level Overview](#1-high-level-overview)
  - [Core Responsibility](#core-responsibility)
...
- [3. Execution & Call Flow](#3-execution-call-flow)
  - [3.1 Full End-to-End Sequence](#31-full-end-to-end-sequence)
  - [3.2 Stage 1: I/O Planning (Constructor Time)](#32-stage-1-io-planning-constructor-time)
  - [3.3 Stage 2: S3 Byte Range Read (Lazy, On-Demand)](#33-stage-2-s3-byte-range-read-lazy-on-demand)
  - [3.4 Stage 3: ChunkedInputStream and Page Parsing](#34-stage-3-chunkedinputstream-and-page-parsing)
  - [3.5 Stage 4: Decompression in PageReader](#35-stage-4-decompression-in-pagereader)
  - [3.6 Stage 5: Value Decoding via FlatColumnReader](#36-stage-5-value-decoding-via-flatcolumnreader)
  - [3.7 Stage 6: ValueDecoder to Typed Buffer](#37-stage-6-valuedecoder-to-typed-buffer)
  - [3.8 Stage 7: Typed Buffer to Block](#38-stage-7-typed-buffer-to-block)
  - [3.9 Stage 8: Block to SourcePage (Lazy Assembly)](#39-stage-8-block-to-sourcepage-lazy-assembly)
  - [3.10 Batch Size Adaptation](#310-batch-size-adaptation)
- [4. Concurrency & State Management](#4-concurrency-state-management)
  - [Threading Model](#threading-model)
  - [I/O Prefetching Strategy](#io-prefetching-strategy)
  - [State Machine](#state-machine)
  - [Reference Counting](#reference-counting)
- [5. Memory & Resource Profile](#5-memory-resource-profile)
  - [Buffer Allocation Points](#buffer-allocation-points)
  - [Key Size Defaults (ParquetReaderOptions)](#key-size-defaults-parquetreaderoptions)
...
- [7. Porting Considerations (Java -> Target Architecture)](#7-porting-considerations-java-target-architecture)
  ...
  - [Async I/O Opportunity](#async-io-opportunity)
  - [Critical Path for Correctness](#critical-path-for-correctness)
