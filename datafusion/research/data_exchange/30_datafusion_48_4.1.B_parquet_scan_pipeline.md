...
- [3. Execution & Call Flow](#3-execution-call-flow)
  - [The 10-State File Opening State Machine](#the-10-state-file-opening-state-machine)
  - [Sequence Diagram](#sequence-diagram)
- [4. Row-Group Pruning: Statistics (Min/Max)](#4-row-group-pruning-statistics-minmax)
  - [4.1 PruningPredicate Construction](#41-pruningpredicate-construction)
  - [4.2 Row Group Statistics Evaluation](#42-row-group-statistics-evaluation)
  - [4.3 Fully Matched Row Group Detection](#43-fully-matched-row-group-detection)
  - [4.4 Bloom Filter Pruning](#44-bloom-filter-pruning)
- [5. Page Index Pruning](#5-page-index-pruning)
  - [5.1 Page-Level Statistics](#51-page-level-statistics)
  - [5.2 Selection Intersection](#52-selection-intersection)
- [6. Row-Level Filtering (Late Materialization)](#6-row-level-filtering-late-materialization)
  - [6.1 RowFilter Construction](#61-rowfilter-construction)
  - [6.2 Pushdown Eligibility Check](#62-pushdown-eligibility-check)
  - [6.3 How Late Materialization Works](#63-how-late-materialization-works)
  - [6.4 Cost-Based Predicate Ordering](#64-cost-based-predicate-ordering)
- [7. Object Store Integration](#7-object-store-integration)
  - [7.1 ParquetFileReaderFactory](#71-parquetfilereaderfactory)
  - [7.2 DefaultParquetFileReaderFactory](#72-defaultparquetfilereaderfactory)
  - [7.3 Byte-Range Fetching](#73-byte-range-fetching)
  - [7.4 Push-Based Decoder I/O Loop](#74-push-based-decoder-io-loop)
- [8. FileScanConfig & File Groups](#8-filescanconfig-file-groups)
  - [8.1 FileScanConfig Structure](#81-filescanconfig-structure)
  - [8.2 Partition Columns (Hive-Style)](#82-partition-columns-hive-style)
  - [8.3 Parallel File Reading](#83-parallel-file-reading)
- [9. Metadata Caching](#9-metadata-caching)
  - [9.1 CachedParquetFileReaderFactory](#91-cachedparquetfilereaderfactory)
  - [9.2 Cache Lookup in get_metadata](#92-cache-lookup-in-get_metadata)
  - [9.3 Default: No Caching](#93-default-no-caching)
- [10. Concurrency & State Management](#10-concurrency-state-management)
  - [10.1 Parallelism Model](#101-parallelism-model)
  - [10.2 No Shared Mutable State](#102-no-shared-mutable-state)
  - [10.3 Dynamic Filter Support](#103-dynamic-filter-support)
- [11. Memory & Resource Profile](#11-memory-resource-profile)
  - [11.1 Memory Held During File Open](#111-memory-held-during-file-open)
  - [11.2 Memory During Decode](#112-memory-during-decode)
  - [11.3 Scan Efficiency Ratio](#113-scan-efficiency-ratio)
- [12. Key Design Insights](#12-key-design-insights)
  - [Insight 1: Explicit State Machine Over Async/Await Chains](#insight-1-explicit-state-machine-over-asyncawait-chains)
  - [Insight 2: Progressive Access Plan Refinement](#insight-2-progressive-access-plan-refinement)
  - [Insight 3: Cost-Based Late Materialization](#insight-3-cost-based-late-materialization)
  - [Insight 4: Inverted Predicate for Full-Match Detection](#insight-4-inverted-predicate-for-full-match-detection)
  - [Insight 5: Partition Column Literal Substitution Before All Pruning](#insight-5-partition-column-literal-substitution-before-all-pruning)
  - [Insight 6: No Default Metadata Caching](#insight-6-no-default-metadata-caching)
  - [Insight 7: Push-Based Decoder for Demand-Driven I/O](#insight-7-push-based-decoder-for-demand-driven-io)
  - [Insight 8: Dynamic Filter Early Stopping](#insight-8-dynamic-filter-early-stopping)
